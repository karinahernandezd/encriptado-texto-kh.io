...
document.querySelector(".encriptar").addEventListener("click", function() {
    ...
    // Muestra el mensaje encriptado en el div output
    ...
    document.querySelector(".output_img").style.display = "none";
    document.querySelector(".output__titulo").style.display = "none";
    document.querySelector(".output__texto").style.display = "none";
...
document.querySelector(".desencriptar").addEventListener("click", function() {
    ...
    // Muestra el mensaje desencriptado en el div output
    const outputDiv = document.querySelector(".output");
    outputDiv.querySelectorAll('.copiar').forEach(button => button.remove());
    outputDiv.querySelectorAll('.mensajeFinal').forEach(p => p.remove());
